...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/dashboard/admin/social", label: "LinkedIn autopilot", icon: Linkedin, team: "growth", roles: ["SUPER_ADMIN", "REVENUE"] },
  ...
  { href: "/dashboard/admin/analytics", label: "Site analytics", icon: BarChart3, team: "platform", roles: ["SUPER_ADMIN"] },
...
export const TEAM_MATRIX = [
  ...
  { team: "Platform (super admin)", areas: "Site analytics, Settings, Health, Team & roles, Feature flags" },
] as const;
