    ...
    <section className="py-16 bg-pearl border-y border-border">
      <div className="container">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">Top-rated <span className="text-primary">dealers</span></h2>
            <p className="text-muted-foreground mt-1">Dealerships with exceptional customer experiences</p>
          </div>
          <Link href="/dealers" className="text-sm font-medium text-primary hover:text-primary hidden sm:block">
            View all →
          </Link>
        </div>
        ...
        <div className="text-center mt-8 sm:hidden">
          <Link href="/dealers" className="text-sm font-medium text-primary hover:text-primary">
