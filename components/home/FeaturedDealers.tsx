    ...
    <section className="py-16 bg-gray-50 border-y border-gray-100">
      <div className="container">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Top-rated <span className="text-gold">dealers</span></h2>
            <p className="text-gray-600 mt-1">Dealerships with exceptional customer experiences</p>
          </div>
          <Link href="/dealers" className="text-sm font-medium text-gold-700 hover:text-gold-800 hidden sm:block">
            View all →
          </Link>
        </div>
        ...
        <div className="text-center mt-8 sm:hidden">
          <Link href="/dealers" className="text-sm font-medium text-gold-700 hover:text-gold-800">
