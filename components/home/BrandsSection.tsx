        ...
        <div className="flex flex-wrap justify-center gap-3">
          {brands.map((brand) => (
            <Link
              ...
              className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-colors"
            >
              {brand.name}
            </Link>
          ))}
