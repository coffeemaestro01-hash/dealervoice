    ...
    <section className="py-16 bg-white">
      <div className="container">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">How DealerVoice works</h2>
          ...
          {STEPS.map((step, i) => (
            <div key={step.step} className="relative text-center">
              ...
              <div className="relative inline-flex flex-col items-center">
                <div className="w-16 h-16 rounded-full bg-blue-50 border-2 border-blue-100 flex items-center justify-center mb-4 relative z-10 bg-white">
                  <step.icon size={24} className="text-blue-600" />
                </div>
                <span className="text-xs font-bold text-blue-600 mb-2">{step.step}</span>
        ...
        <div className="text-center mt-10">
          <Link href="/register">
            <Button size="lg" className="bg-blue-700 hover:bg-blue-800">Start for Free</Button>
          </Link>
        </div>
      </div>
    </section>
