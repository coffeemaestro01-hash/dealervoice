...
export function PremiumUpgradeBanner({
  ...
  return (
    <div className="mb-6 rounded-2xl border-2 border-primary/30 bg-gradient-to-r from-background to-muted p-5 md:p-6 text-foreground shadow-lg">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-wider text-primary mb-1">Remove competitor ads</p>
            ...
            <ul className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-xs text-muted-foreground">
              <li className="flex items-center gap-1"><X size={12} className="text-primary" /> No competitor ads</li>
              <li className="flex items-center gap-1"><X size={12} className="text-primary" /> Live inventory CTA</li>
        ...
        <div className="flex flex-col sm:flex-row gap-2 shrink-0">
          <Link href={billingHref}>
            <Button className="w-full sm:w-auto bg-ember text-night-900 font-bold hover:opacity-90 border-0">
              Upgrade to Pro
            </Button>
          </Link>
          <Link href={`/pricing?dealer=${dealershipId}`}>
            <Button variant="outline" className="w-full sm:w-auto border-primary/30 text-primary hover:bg-primary/10">
              Compare plans
            </Button>
          </Link>
        </div>
