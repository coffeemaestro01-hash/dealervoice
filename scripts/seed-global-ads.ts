...
const PLACEMENTS = [
  ...
  },
  {
    slot: "homepage_financing",
    adType: "Tier2_OEM_Offer",
    headline: "Compare car rental deals",
    subheadline: "Search DiscoverCars for the best rates — book online in minutes.",
    ctaLabel: "Search rentals",
    ctaHref: "https://naiawork.com/g/wqjhitsyjq51daf7bf5c5ea594bb46/",
    badge: "DiscoverCars · Partner",
    accent: "bg-ember",
    countryCode: "US",
