    ...
    <div className="bg-white">
      <div className="container max-w-3xl py-14">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section><h2 className="text-xl font-bold text-gray-900">Reporting infringement</h2><p>If you believe content on DealerVoice infringes your copyright, send a notice to <a href="mailto:legal@dealervoice.io" className="text-gold-700 hover:underline">legal@dealervoice.io</a> including: identification of the work, the URL of the infringing content, your contact details, and a good-faith statement.</p></section>
