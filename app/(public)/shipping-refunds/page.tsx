  ...
  return (
    <div className="bg-white">
      <div className="container max-w-3xl py-14">
        ...
        <p className="text-sm text-gray-500 mb-10">Last updated: June 2026 · Billed in USD via Stripe</p>
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>Billing disputes can be raised at <a href="mailto:billing@dealervoice.io" className="text-gold-700 hover:underline">billing@dealervoice.io</a> or via our <a href="/contact" className="text-gold-700 hover:underline">contact page</a>. We aim to respond within 5 business days.</p>
          </section>
        </div>
      </div>
    </div>
