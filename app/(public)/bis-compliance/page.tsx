    ...
    <div className="bg-card">
      <div className="container max-w-3xl py-14">
        <h1 className="text-4xl font-extrabold text-foreground mb-2">
          Review <span className="text-primary">standards</span>
        </h1>
        ...
        <div className="space-y-6 text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground">No incentives, no bias</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground">Disputes &amp; grievances</h2>
            <p>
              Disputes about reviews or listings can be raised through our{" "}
              <a href="/grievance" className="text-primary hover:underline">support &amp; grievances</a> channel.
